...
?>
    ...
    <body class="hold-transition dark-mode layout-top-nav">
        <div class="wrapper">
            ...
            $gambar_user = $_SESSION['fotosiswa'] ?? 'dist/img/user2-160x160.jpg';
            ?>

            <nav class="main-header navbar navbar-expand navbar-dark">
                <ul class="navbar-nav">
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="index.php?halaman=dashboardsiswa" class="nav-link">Home</a>
                    </li>
                </ul>
                ...
                <div class="marquee-container d-none d-md-block">
                    <span class="marquee-text">
                        ⭐ SELAMAT DATANG,
                        <span class="glow-name"><?php echo strtoupper(htmlspecialchars($nama)); ?></span>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo $gambar_user; ?>" class="user-image img-circle elevation-2">
                            <span class="d-none d-md-inline"><?php echo htmlspecialchars($nama); ?></span>
                        </a>

                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            <li class="user-header">
                                <img src="<?php echo $gambar_user; ?>" class="img-circle elevation-2">
                                <p>
