...
<div class="container">
    <!-- Form Registrasi -->
    <div class="left">
        <img src="https://cdn-icons-png.flaticon.com/512/3135/3135755.png" alt="Logo siswa" class="logo">
        <h2>Registrasi Siswa Baru</h2>
        <form method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
            <input type="number" name="idkelas" placeholder="ID Kelas (contoh: 1)" required>
        ...
        <p>Sudah punya akun? <a href="index.php?halaman=loginsiswa">Login di sini</a></p>
    </div>

    <!-- Bagian Welcome -->
    <div class="right">
        <img src="https://cdn-icons-png.flaticon.com/512/201/201818.png" alt="Icon buku">
        <h3>Selamat Datang di Sistem Absensi!</h3>
        <p>Hai siswa! Yuk, daftarkan dirimu untuk mulai menggunakan sistem absensi sekolah yang modern, mudah, dan cepat.</p>
        <a href="index.php?halaman=loginsiswa">Sudah punya akun? Login</a>
    </div>
</div>
